...
function App() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-white via-rose-50 to-blue-50 text-slate-800">
      {isLoading && <Loader />}
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -left-20 top-[-80px] h-72 w-72 rounded-full bg-rose-200/60 blur-[100px] animate-blob" />
